...
parserFactory.register("ddtxt8.cc", () => new LightNovelCrawlerDdxSssParser());
parserFactory.register("ddxss.cc", () => new LightNovelCrawlerDdxSssParser());


class LightNovelCrawlerDdxSssParser extends Parser {
    constructor() {
        super();
    }
    ...
    findContent(dom) {
        const selector = "div#chaptercontent";
        if (selector) {
