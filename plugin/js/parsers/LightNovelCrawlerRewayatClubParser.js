...
parserFactory.register("rewayat.club", () => new LightNovelCrawlerRewayatClubParser());


class LightNovelCrawlerRewayatClubParser extends Parser {
    constructor() {
        super();
    }
    ...
    removeUnwantedElementsFromContentElement(element) {
        const removeSelectors = [".code-block"];
        const removeTags = [];
