...
parserFactory.register("ornovel.com", () => new LightNovelCrawlerOrNovelParser());


class LightNovelCrawlerOrNovelParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".author-container";
        if (!selector) {
    ...
    findContent(dom) {
        const selector = "div.chapter-detail";
        if (selector) {
