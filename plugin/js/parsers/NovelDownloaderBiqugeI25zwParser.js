...
parserFactory.register("www.i25zw.com", () => new NovelDownloaderBiqugeI25zwParser());

class NovelDownloaderBiqugeI25zwParser extends Parser {
    constructor() {
        super();
    }
    ...
    applyIntroPatch(introDom, doc) {
        let font = introDom.querySelector("font");
        if (font && font.parentElement) {
            font.parentElement.remove();
        }
        rms(["\u7b80\u4ecb:"] , introDom);
    }
