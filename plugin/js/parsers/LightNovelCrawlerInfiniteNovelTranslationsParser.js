...
parserFactory.register("infinitenoveltranslations.net", () => new LightNovelCrawlerInfiniteNovelTranslationsParser());


class LightNovelCrawlerInfiniteNovelTranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".entry-content p a[href*=\"infinitenoveltranslations.net\"]";
        if (!selector) {
