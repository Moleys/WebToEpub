...
parserFactory.register("jaomix.ru", () => new LightNovelCrawlerJaomixParser());


class LightNovelCrawlerJaomixParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".flex-dow-txt a";
        if (!selector) {
    ...
    findContent(dom) {
        const selector = ".entry-content .entry";
        if (selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = "div.img-book img";
        if (selector) {
