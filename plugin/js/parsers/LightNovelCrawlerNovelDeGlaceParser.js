...
parserFactory.register("noveldeglace.com", () => new LightNovelCrawlerNovelDeGlaceParser());


class LightNovelCrawlerNovelDeGlaceParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.su-tabs-panes";
        if (!selector) {
    ...
    findContent(dom) {
        const selector = "div.content-tome";
        if (selector) {
