...
parserFactory.register("www.shaoniandream.com", () => new NovelDownloaderWwwShaoniandreamComParser());

class NovelDownloaderWwwShaoniandreamComParser extends Parser {
    constructor() {
        super();
        this.pixivMeta = null;
    }
