...
parserFactory.register("wuxialeague.com", () => new LightNovelCrawlerWuxiaLeagueParser());


class LightNovelCrawlerWuxiaLeagueParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "#chapterList li a";
        if (!selector) {
