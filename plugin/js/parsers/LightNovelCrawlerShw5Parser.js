...
parserFactory.register("bq99.cc", () => new LightNovelCrawlerShw5Parser());
parserFactory.register("p2wt.com", () => new LightNovelCrawlerShw5Parser());


class LightNovelCrawlerShw5Parser extends Parser {
    constructor() {
        super();
    }
    ...
    extractAuthor(dom) {
        const selector = ".book .small span";
        if (selector) {
