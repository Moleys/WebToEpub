...
parserFactory.register("kitenovel.com", () => new LightNovelCrawlerKiteNovelParser());


class LightNovelCrawlerKiteNovelParser extends Parser {
    constructor() {
        super();
    }
    ...
    findCoverImageUrl(dom) {
        const selector = "div.col-md-8.col-sm-8.pt-2 > p:nth-child(2)";
        if (selector) {
