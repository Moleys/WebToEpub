...
parserFactory.register("tw.uukanshu.net", () => new LightNovelCrawlerUukanshuOnlineParser());
parserFactory.register("uukanshu.net", () => new LightNovelCrawlerUukanshuOnlineParser());


class LightNovelCrawlerUukanshuOnlineParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "ul#chapterList";
        if (!selector) {
