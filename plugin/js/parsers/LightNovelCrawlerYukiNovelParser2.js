...
parserFactory.register("yukinovel.id", () => new LightNovelCrawlerYukiNovelParser2());
parserFactory.register("yukinovel.me", () => new LightNovelCrawlerYukiNovelParser2());


class LightNovelCrawlerYukiNovelParser2 extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.lightnovel-episode ul li a";
        if (!selector) {
    ...
    findContent(dom) {
        const selector = "div.entry-content.cl";
        if (selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = "div.lightnovel-thumb img";
        if (selector) {
