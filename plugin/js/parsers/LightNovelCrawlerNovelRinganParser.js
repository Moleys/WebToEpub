...
parserFactory.register("novelringan.com", () => new LightNovelCrawlerNovelRinganParser());


class LightNovelCrawlerNovelRinganParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".bxcl ul li a";
        if (!selector) {
    ...
    extractAuthor(dom) {
        const selector = ".entry-author a[href*=\"/author/\"]";
        if (selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = "div.imgprop img";
        if (selector) {
