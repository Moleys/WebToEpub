...
parserFactory.register("meionovels.com", () => new LightNovelCrawlerMeionovelParser());


class LightNovelCrawlerMeionovelParser extends Parser {
    constructor() {
        super();
    }
    ...
    getInformationEpubItemChildNodes(dom) {
        const selector = ".summary__content";
