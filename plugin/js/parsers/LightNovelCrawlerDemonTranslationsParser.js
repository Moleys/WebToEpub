...
parserFactory.register("demontranslations.com", () => new LightNovelCrawlerDemonTranslationsParser());


class LightNovelCrawlerDemonTranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.entry-content li [href*=\"demontranslations\"]";
        if (!selector) {
