...
parserFactory.register("banxia.cc", () => new LightNovelCrawlerXbanxiaParser());
parserFactory.register("xbanxia.com", () => new LightNovelCrawlerXbanxiaParser());


class LightNovelCrawlerXbanxiaParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.book-describe p";
        if (!selector) {
