...
parserFactory.register("daocaorenshuwu.com", () => new LightNovelCrawlerDaocaorenshuwuParser());


class LightNovelCrawlerDaocaorenshuwuParser extends Parser {
    constructor() {
        super();
    }
    ...
    extractTitleImpl(dom) {
        const selector = ".container .media-left a img";
