...
parserFactory.register("rpgnoob.wordpress.com", () => new LightNovelCrawlerRPGNovelsParser());
parserFactory.register("rpgnovels.com", () => new LightNovelCrawlerRPGNovelsParser());


class LightNovelCrawlerRPGNovelsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.post-entry li a[href*=\"rpg\"]";
        if (!selector) {
    ...
    extractAuthor(dom) {
        const selector = ".post-entry a[href*=\"mypage.syosetu.com\"]";
        if (selector) {
