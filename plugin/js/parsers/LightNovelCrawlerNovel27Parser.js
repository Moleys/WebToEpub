...
parserFactory.register("novel27.com", () => new LightNovelCrawlerNovel27Parser());


class LightNovelCrawlerNovel27Parser extends Parser {
    constructor() {
        super();
    }
    ...
    extractAuthor(dom) {
        const selector = ".author-content a[href*=\"authors\"]";
        if (selector) {
