...
parserFactory.register("zhi-end.blogspot.co.id", () => new LightNovelCrawlerZhiEndParser());
parserFactory.register("zhi-end.blogspot.com", () => new LightNovelCrawlerZhiEndParser());


class LightNovelCrawlerZhiEndParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.entry-content div [href*=\"zhi-end.blogspot\"]";
        if (!selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = "div.entry-content div a img";
        if (selector) {
