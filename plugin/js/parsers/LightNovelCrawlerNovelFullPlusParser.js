...
parserFactory.register("novelfullplus.com", () => new LightNovelCrawlerNovelFullPlusParser());


class LightNovelCrawlerNovelFullPlusParser extends Parser {
    constructor() {
        super();
    }
