...
parserFactory.register("newsnovel.net", () => new LightNovelCrawlerNewsNovelParser());


class LightNovelCrawlerNewsNovelParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".home-truyendecu";
        if (!selector) {
