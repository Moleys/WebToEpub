...
parserFactory.register("xiaowaz.fr", () => new LightNovelCrawlerXiaowazParser());


class LightNovelCrawlerXiaowazParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".entry-content a[href*='/articles/']";
        if (!selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = ".entry-content img";
        if (selector) {
