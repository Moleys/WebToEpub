...
parserFactory.register("turkcelightnovels.com", () => new IReaderTurkceLightNovelsParser());

class IReaderTurkceLightNovelsParser extends Parser {
    constructor() {
        super();
    }
    ...
    getInformationEpubItemChildNodes(dom) {
        const selector = ".description-summary";
