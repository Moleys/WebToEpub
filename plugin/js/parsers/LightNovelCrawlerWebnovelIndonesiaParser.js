...
parserFactory.register("webnovelindonesia.com", () => new LightNovelCrawlerWebnovelIndonesiaParser());


class LightNovelCrawlerWebnovelIndonesiaParser extends Parser {
    constructor() {
        super();
    }
    ...
    extractTitleImpl(dom) {
        const selector = ".breadcrumb .breadcrumb-item.active";
    ...
    findCoverImageUrl(dom) {
        const selector = ".section-novel img[class*=\"lazy\"]";
        if (selector) {
