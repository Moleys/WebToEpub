...
parserFactory.register("asadatranslations.com", () => new LightNovelCrawlerAsadaTranslationsParser());


class LightNovelCrawlerAsadaTranslationsParser extends Parser {
    constructor() {
        super();
    }
