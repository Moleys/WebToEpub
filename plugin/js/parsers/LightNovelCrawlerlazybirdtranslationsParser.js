...
parserFactory.register("lazybirdtranslations.wordpress.com", () => new LightNovelCrawlerlazybirdtranslationsParser());


class LightNovelCrawlerlazybirdtranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".wp-block-table tr td a[href*=\"lazybirdtranslations.wordpress.com/2\"]";
        if (!selector) {
