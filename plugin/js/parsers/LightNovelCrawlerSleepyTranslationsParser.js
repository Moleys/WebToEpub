...
parserFactory.register("sleepytranslations.com", () => new LightNovelCrawlerSleepyTranslationsParser());


class LightNovelCrawlerSleepyTranslationsParser extends Parser {
    constructor() {
        super();
    }
    ...
    extractAuthor(dom) {
        const selector = ".author-content a[href*=\"author\"]";
        if (selector) {
