...
parserFactory.register("fenrirtranslations.com", () => new LightNovelCrawlerFenrirTranslationsParser());


class LightNovelCrawlerFenrirTranslationsParser extends Parser {
    constructor() {
        super();
    }
    ...
    getInformationEpubItemChildNodes(dom) {
        const selector = ".description-summary a";
        return selector ? [...dom.querySelectorAll(selector)] : [];
    }

    removeUnwantedElementsFromContentElement(element) {
        const removeSelectors = ["a[href=\"javascript:void(0)\"]"];
        const removeTags = ["h3"];
