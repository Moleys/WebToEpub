...
parserFactory.register("webnovelonline.net", () => new LightNovelCrawlerWebNovelOnlineNetParser());


class LightNovelCrawlerWebNovelOnlineNetParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".listing-chapters_wrap ul li";
        if (!selector) {
    ...
    extractAuthor(dom) {
        const selector = ".author-content a";
        if (selector) {
