...
parserFactory.register("smnovels.com", () => new LightNovelCrawlerSMNovelsParser());


class LightNovelCrawlerSMNovelsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".all-chapters-list a";
        if (!selector) {
