...
parserFactory.register("americanfaux.com", () => new LightNovelCrawlerAmericanFauxParser());


class LightNovelCrawlerAmericanFauxParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".entry-content a[href*=\"americanfaux.com/index.php/\"]";
        if (!selector) {
