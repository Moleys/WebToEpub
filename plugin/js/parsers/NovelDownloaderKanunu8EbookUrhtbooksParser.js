...
parserFactory.register("ebook.urhtbooks.com", () => new NovelDownloaderKanunu8EbookUrhtbooksParser());

class NovelDownloaderKanunu8EbookUrhtbooksParser extends Parser {
    constructor() {
        super();
    }
