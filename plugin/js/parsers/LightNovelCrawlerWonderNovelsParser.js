...
parserFactory.register("wondernovels.com", () => new LightNovelCrawlerWonderNovelsParser());


class LightNovelCrawlerWonderNovelsParser extends Parser {
    constructor() {
        super();
    }
    ...
    extractAuthor(dom) {
        const selector = ".author-content a[href*=\"translator\"]";
        if (selector) {
