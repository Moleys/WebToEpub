...
parserFactory.register("mangachill.io", () => new LightNovelCrawlerManhwachillLoveParser());
parserFactory.register("mangachill.love", () => new LightNovelCrawlerManhwachillLoveParser());


class LightNovelCrawlerManhwachillLoveParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "ul.main li.wp-manga-chapter a";
        if (!selector) {
