...
parserFactory.register("shubl.com", () => new NovelDownloaderShublParser());

class NovelDownloaderShublParser extends Parser {
    constructor() {
        super();
    ...
    extractDescription(dom) {
        ...
        if (intro && intro.textContent) {
            return intro.textContent.replace("\u7b80\u4ecb\uff1a", "").trim();
        }
    ...
    async fetchChapter(url) {
        ...
        let html = await decryptChapter(chapterId, url, SHUBL_ROOT_PATH);
...
const SHUBL_ROOT_PATH = "https://www.cddaoyue.cn/";
