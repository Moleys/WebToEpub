...
parserFactory.register("koreanmtl.online", () => new LightNovelCrawlerLightNovelsOnlParser());


class LightNovelCrawlerLightNovelsOnlParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".post-body.entry-content ul li a";
        if (!selector) {
