...
parserFactory.register("steambunlightnovel.com", () => new LightNovelCrawlerSteambunParser());


class LightNovelCrawlerSteambunParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.w4pl-inner li a[href*=\"steambunlightnovel.com\"]";
        if (!selector) {
