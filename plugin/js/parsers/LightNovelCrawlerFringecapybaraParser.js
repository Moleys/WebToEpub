...
parserFactory.register("fringecapybara.com", () => new LightNovelCrawlerFringecapybaraParser());


class LightNovelCrawlerFringecapybaraParser extends Parser {
    constructor() {
        super();
    }
    ...
    findContent(dom) {
        const selector = ".blog-item-content-wrapper, .entry-content";
        if (selector) {
    ...
    extractTitleImpl(dom) {
        const selector = "figure.sqs-block-image-figure img";
