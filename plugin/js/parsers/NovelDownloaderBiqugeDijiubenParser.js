...
parserFactory.register("dijiuben.com", () => new NovelDownloaderBiqugeDijiubenParser());

class NovelDownloaderBiqugeDijiubenParser extends Parser {
    constructor() {
        super();
    }
    ...
    async getChapterUrls(dom) {
        ...
        chapters = chapters.filter(c => {
            let url = new URL(c.sourceUrl);
            if (url.host === "m.dijiuben.com") {
                return false;
            }
            return !url.href.endsWith(".apk");
        });
