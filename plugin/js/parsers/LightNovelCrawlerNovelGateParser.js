...
parserFactory.register("home.novel-gate.com", () => new LightNovelCrawlerNovelGateParser());


class LightNovelCrawlerNovelGateParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".block-film #list-chapters .book";
        if (!selector) {
