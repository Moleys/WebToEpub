...
parserFactory.register("librarynovel.com", () => new LightNovelCrawlerLibraryNovelParser());


class LightNovelCrawlerLibraryNovelParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".wp-manga-chapter a[href*=\"/novel\"]";
        if (!selector) {
