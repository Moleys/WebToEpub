...
parserFactory.register("www.lewenn.net", () => new NovelDownloaderBiqugeLewennParser());

class NovelDownloaderBiqugeLewennParser extends Parser {
    constructor() {
        super();
    }
    ...
    applyIntroPatch(introDom, doc) {
        rms([/\u5404\u4f4d\u4e66\u53cb\u8981\u662f\u89c9\u5f97\u300a.*\u300b\u8fd8\u4e0d\u9519\u7684\u8bdd\u8bf7\u4e0d\u8981\u5fd8\u8bb0\u5411\u60a8QQ\u7fa4\u548c\u5fae\u535a\u91cc\u7684\u670b\u53cb\u63a8\u8350\u54e6\uff01/], introDom);
    }
