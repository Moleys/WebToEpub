...
parserFactory.register("litnet.com", () => new LightNovelCrawlerLitnetParser2());


class LightNovelCrawlerLitnetParser2 extends Parser {
    constructor() {
        super();
        this.csrfToken = null;
        this.csrfParam = null;
    ...
    async fetchChapter(url) {
        ...
        return LightNovelCrawlerLitnetParser2.textToDoc(content, url);
    }
