...
parserFactory.register("inadequatetranslations.wordpress.com", () => new LightNovelCrawlerInadequateTranslationsParser());


class LightNovelCrawlerInadequateTranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".entry-content a[href*=\"inadequatetranslations.wordpress.com\"]";
        if (!selector) {
