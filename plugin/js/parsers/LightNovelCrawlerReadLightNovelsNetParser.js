...
parserFactory.register("readlightnovels.net", () => new LightNovelCrawlerReadLightNovelsNetParser());


class LightNovelCrawlerReadLightNovelsNetParser extends Parser {
    constructor() {
        super();
    }
