...
parserFactory.register("ebook.longmabook.com", () => new NovelDownloaderKanunu8EbookLongmabookParser());

class NovelDownloaderKanunu8EbookLongmabookParser extends Parser {
    constructor() {
        super();
    }
