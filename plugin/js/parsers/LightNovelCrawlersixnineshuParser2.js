...
parserFactory.register("69shu.com", () => new LightNovelCrawlersixnineshuParser2());
parserFactory.register("69shu.pro", () => new LightNovelCrawlersixnineshuParser2());
parserFactory.register("69shuba.pro", () => new LightNovelCrawlersixnineshuParser2());
parserFactory.register("69xinshu.com", () => new LightNovelCrawlersixnineshuParser2());


class LightNovelCrawlersixnineshuParser2 extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.newbox ul li";
        if (!selector) {
