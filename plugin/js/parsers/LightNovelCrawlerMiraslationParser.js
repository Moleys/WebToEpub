...
parserFactory.register("miraslation.net", () => new LightNovelCrawlerMiraslationParser());


class LightNovelCrawlerMiraslationParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "article.posts-entry p [href*=\"miraslation.net/novels/\"]";
        if (!selector) {
