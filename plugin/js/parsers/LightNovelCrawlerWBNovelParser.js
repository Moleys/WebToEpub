...
parserFactory.register("wbnovel.com", () => new LightNovelCrawlerWBNovelParser());


class LightNovelCrawlerWBNovelParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = " .page-content-listing";
        if (!selector) {
    ...
    extractTitleImpl(dom) {
        const selector = ".post-title h1, .post-title h3";
