...
parserFactory.register("huayu.zongheng.com", () => new NovelDownloaderHuayuZonghengComParser());

class NovelDownloaderHuayuZonghengComParser extends Parser {
    constructor() {
        super();
        this.bookInfo = null;
    }
