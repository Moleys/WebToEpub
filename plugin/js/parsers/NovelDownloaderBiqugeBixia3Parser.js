...
parserFactory.register("www.bixia3.com", () => new NovelDownloaderBiqugeBixia3Parser());

class NovelDownloaderBiqugeBixia3Parser extends Parser {
    constructor() {
        super();
    }
    ...
    findContent(dom) {
        return dom.querySelector("#zjneirong");
    }
    ...
    applyContentPatch(content) {
        let xuanchuan = content.querySelector("#xuanchuan");
        if (xuanchuan && xuanchuan.parentElement) {
            xuanchuan.parentElement.remove();
        }
