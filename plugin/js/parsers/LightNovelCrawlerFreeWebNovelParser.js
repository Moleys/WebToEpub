...
parserFactory.register("innread.com", () => new LightNovelCrawlerFreeWebNovelParser());
parserFactory.register("libread.org", () => new LightNovelCrawlerFreeWebNovelParser());


class LightNovelCrawlerFreeWebNovelParser extends Parser {
    constructor() {
        super();
    }
