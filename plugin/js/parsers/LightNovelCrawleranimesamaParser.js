...
parserFactory.register("anime-sama.fr", () => new LightNovelCrawleranimesamaParser());


class LightNovelCrawleranimesamaParser extends Parser {
    constructor() {
        super();
    }
