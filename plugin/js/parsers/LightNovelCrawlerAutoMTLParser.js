...
parserFactory.register("automtl.wordpress.com", () => new LightNovelCrawlerAutoMTLParser());


class LightNovelCrawlerAutoMTLParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.wp-block-group__inner-container [href*=\"automtl.wordpress.com/\"]";
        if (!selector) {
