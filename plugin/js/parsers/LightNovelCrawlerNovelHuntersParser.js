...
parserFactory.register("novelhunters.com", () => new LightNovelCrawlerNovelHuntersParser());


class LightNovelCrawlerNovelHuntersParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".c-tabs-item__content";
        if (!selector) {
    ...
    extractAuthor(dom) {
        const selector = ".wp-manga-action-button[data-action=bookmark]";
        if (selector) {
