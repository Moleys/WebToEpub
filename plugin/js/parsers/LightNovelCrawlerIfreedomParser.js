...
parserFactory.register("bookhamster.ru", () => new LightNovelCrawlerIfreedomParser());
parserFactory.register("funbook.su", () => new LightNovelCrawlerIfreedomParser());
parserFactory.register("ifreedom.su", () => new LightNovelCrawlerIfreedomParser());


class LightNovelCrawlerIfreedomParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".menu-ranobe a";
        if (!selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = "div.img-ranobe img";
        if (selector) {
    ...
    getInformationEpubItemChildNodes(dom) {
        const selector = "div.descr-ranobe";
