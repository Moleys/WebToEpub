...
parserFactory.register("grensia.blogspot.com", () => new LightNovelCrawlerGreensiaParser());


class LightNovelCrawlerGreensiaParser extends Parser {
    constructor() {
        super();
    }
