...
parserFactory.register("aquamanga.com", () => new LightNovelCrawlerAquaMangaParser());
parserFactory.register("aquamanga.org", () => new LightNovelCrawlerAquaMangaParser());
parserFactory.register("aquareader.net", () => new LightNovelCrawlerAquaMangaParser());


class LightNovelCrawlerAquaMangaParser extends Parser {
    constructor() {
        super();
    }
