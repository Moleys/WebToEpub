...
parserFactory.register("totallytranslations.com", () => new LightNovelCrawlerTotallyTranslationsParser());


class LightNovelCrawlerTotallyTranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".chapters-list .chapters-title";
        if (!selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = ".novel-image img";
        if (selector) {
