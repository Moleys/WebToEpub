...
parserFactory.register("xiainovel.com", () => new LightNovelCrawlerYukiNovelParser());


class LightNovelCrawlerYukiNovelParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "ul.list-group li a";
        if (!selector) {
    ...
    findContent(dom) {
        const selector = "section#StoryContent";
        if (selector) {
    ...
    extractTitleImpl(dom) {
        const selector = "div.col-md-6 img";
