...
parserFactory.register("ancientheartloss.com", () => new LightNovelCrawlerAncientHeartlossParser());
parserFactory.register("ancientheartloss.wordpress.com", () => new LightNovelCrawlerAncientHeartlossParser());


class LightNovelCrawlerAncientHeartlossParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".entry-content p a[href*=\"ancientheartloss\"]";
        if (!selector) {
