...
parserFactory.register("lemontreetranslations.wordpress.com", () => new LightNovelCrawlerLemonTreeTranslationsParser());


class LightNovelCrawlerLemonTreeTranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.entry-content ul li [href*=\"lemontreetranslations\"]";
        if (!selector) {
