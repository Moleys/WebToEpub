...
parserFactory.register("piaotian.com", () => new LightNovelCrawlerPiaoTianParser());
parserFactory.register("ptwxz.com", () => new LightNovelCrawlerPiaoTianParser());


class LightNovelCrawlerPiaoTianParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div#content table tr";
        if (!selector) {
