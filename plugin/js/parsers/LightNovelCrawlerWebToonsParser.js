...
parserFactory.register("webtoons.com", () => new LightNovelCrawlerWebToonsParser());


class LightNovelCrawlerWebToonsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "ul.card_lst li";
        if (!selector) {
