...
parserFactory.register("wuxiasky.net", () => new LightNovelCrawlerAsiaNovelNetParser());


class LightNovelCrawlerAsiaNovelNetParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.story__identity div.story__identity-meta a.author";
        if (!selector) {
