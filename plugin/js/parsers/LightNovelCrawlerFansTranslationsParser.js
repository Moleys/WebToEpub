...
parserFactory.register("fanstranslations.com", () => new LightNovelCrawlerFansTranslationsParser());


class LightNovelCrawlerFansTranslationsParser extends Parser {
    constructor() {
        super();
    }
