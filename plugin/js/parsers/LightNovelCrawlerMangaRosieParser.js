...
parserFactory.register("mangarosie.love", () => new LightNovelCrawlerMangaRosieParser());
parserFactory.register("mangarosie.me", () => new LightNovelCrawlerMangaRosieParser());
parserFactory.register("toon69.com", () => new LightNovelCrawlerMangaRosieParser());


class LightNovelCrawlerMangaRosieParser extends Parser {
    constructor() {
        super();
    }
    ...
    findContent(dom) {
        const selector = "div.reading-content";
        if (selector) {
    ...
    extractAuthor(dom) {
        const selector = ".author-content a[href*=\"manga-author\"]";
        if (selector) {
