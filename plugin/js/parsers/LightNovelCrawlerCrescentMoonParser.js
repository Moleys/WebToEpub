...
parserFactory.register("crescentmoon.blog", () => new LightNovelCrawlerCrescentMoonParser());


class LightNovelCrawlerCrescentMoonParser extends Parser {
    constructor() {
        super();
    }
    ...
    findCoverImageUrl(dom) {
        const selector = "div.entry-content p a";
        if (selector) {
