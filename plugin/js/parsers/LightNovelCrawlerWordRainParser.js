...
parserFactory.register("wordrain69.com", () => new LightNovelCrawlerWordRainParser());


class LightNovelCrawlerWordRainParser extends Parser {
    constructor() {
        super();
    }
    ...
    extractAuthor(dom) {
        const selector = ".author-content a[href*=\"manga-translator\"]";
        if (selector) {
