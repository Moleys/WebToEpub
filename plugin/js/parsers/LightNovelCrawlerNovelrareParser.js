...
parserFactory.register("novelrare.com", () => new LightNovelCrawlerNovelrareParser());


class LightNovelCrawlerNovelrareParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.listing-chapters_wrap";
        if (!selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = "div.summary_image img";
        if (selector) {
    ...
    getInformationEpubItemChildNodes(dom) {
        const selector = "div[aria-labelledby='manga-info'] p";
