...
parserFactory.register("wuxiaworldsite.co", () => new LightNovelCrawlerWuxiaSiteCoParser());


class LightNovelCrawlerWuxiaSiteCoParser extends Parser {
    constructor() {
        super();
    }
    ...
    findContent(dom) {
        const selector = "div.content-story";
        if (selector) {
    ...
    findCoverImageUrl(dom) {
        const selector = ".read-item .img-read img";
        if (selector) {
