...
parserFactory.register("whatsawhizzerwebnovels.com", () => new LightNovelCrawlerWhatsAWhizzerParser());


class LightNovelCrawlerWhatsAWhizzerParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".entry > p > a";
        if (!selector) {
    ...
    extractTitleImpl(dom) {
        const selector = ".page-header-title";
