...
parserFactory.register("domentranslations.wordpress.com", () => new LightNovelCrawlerCclawTranslationsParser());


class LightNovelCrawlerCclawTranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.entry-content a";
        if (!selector) {
