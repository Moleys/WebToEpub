...
parserFactory.register("mostnovel.com", () => new LightNovelCrawlerMostNovelParser());


class LightNovelCrawlerMostNovelParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".wp-manga-chapter a[href*=\"/manga\"]";
        if (!selector) {
