...
parserFactory.register("neosekaitranslations.com", () => new LightNovelCrawlerNeoSekaiParser());


class LightNovelCrawlerNeoSekaiParser extends Parser {
    constructor() {
        super();
    }
    ...
    extractAuthor(dom) {
        const selector = "#manga-chapters-holder";
        if (selector) {
