...
parserFactory.register("wujizun.com", () => new LightNovelCrawlerWujizunParser());


class LightNovelCrawlerWujizunParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.entry-content p a[href*=\"wujizun.com/2\"]";
        if (!selector) {
