...
parserFactory.register("earlynovel.net", () => new LightNovelCrawlerMixedNovelNetParser());
parserFactory.register("mixednovel.net", () => new LightNovelCrawlerMixedNovelNetParser());


class LightNovelCrawlerMixedNovelNetParser extends Parser {
    constructor() {
        super();
    }
    ...
    findContent(dom) {
        const selector = ".reading-content .text-left";
        if (selector) {
    ...
    extractAuthor(dom) {
        const selector = ".summary-content a[href*=\"/novel-author/\"]";
        if (selector) {
