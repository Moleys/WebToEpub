...
parserFactory.register("vistranslations.wordpress.com", () => new LightNovelCrawlerVisTranslationsParser());


class LightNovelCrawlerVisTranslationsParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "table td a[href*=\"vistranslations.wordpress.com\"]";
        if (!selector) {
