...
parserFactory.register("xnunu.com", () => new LightNovelCrawlerXnunuParser());


class LightNovelCrawlerXnunuParser extends Parser {
    constructor() {
        super();
    }
    ...
    extractTitleImpl(dom) {
        const selector = "img.thumbnail";
        return selector ? dom.querySelector(selector) : super.extractTitleImpl(dom);
    }

    extractAuthor(dom) {
        const selector = "ol.breadcrumb > li:nth-child(2) > a";
        if (selector) {
