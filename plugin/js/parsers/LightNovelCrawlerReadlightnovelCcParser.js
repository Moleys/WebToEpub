...
parserFactory.register("m.readlightnovel.cc", () => new LightNovelCrawlerReadlightnovelCcParser());


class LightNovelCrawlerReadlightnovelCcParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "ul.chapter-list a";
        if (!selector) {
    ...
    findContent(dom) {
        const selector = "div.chapter-entity";
        if (selector) {
