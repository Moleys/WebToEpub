...
parserFactory.register("dobelyuwai.wordpress.com", () => new LightNovelCrawlerDobelyuwaiParser());


class LightNovelCrawlerDobelyuwaiParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "div.entry-content a[href*=\"https://dobelyuwai.wordpress.com/2\"]";
        if (!selector) {
