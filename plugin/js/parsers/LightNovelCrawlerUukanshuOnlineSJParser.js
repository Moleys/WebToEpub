...
parserFactory.register("sj.uukanshu.net", () => new LightNovelCrawlerUukanshuOnlineSJParser());


class LightNovelCrawlerUukanshuOnlineSJParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = "ul#chapterList li a";
        if (!selector) {
