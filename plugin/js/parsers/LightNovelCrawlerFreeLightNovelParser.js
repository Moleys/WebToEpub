...
parserFactory.register("freelightnovel.com", () => new LightNovelCrawlerFreeLightNovelParser());


class LightNovelCrawlerFreeLightNovelParser extends Parser {
    constructor() {
        super();
    }

    async getChapterUrls(dom) {
        const selector = ".book-toc .dropdown-menu li.leaf a";
        if (!selector) {
    ...
    extractTitleImpl(dom) {
        const selector = ".content img.img-responsive";
